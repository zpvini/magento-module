    ...
    public function boletoTransaction($order, $data, Uecommerce_Mundipagg_Model_Standard $standard)
    {
        ...
        try {
            ...
            if ($success === false) {
                ...
                //if the boletoUrl was not correctly generated by API, the order will fail.
                if (strlen($response['BoletoTransactionResultCollection'][0]['BoletoUrl']) < 5) {
                    $helperLog->info('With failure on BoletoUrl');
